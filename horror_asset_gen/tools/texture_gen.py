...
class TextureGenerator:
    ...
    def generate_noise(self, scale=10.0, octaves=4, persistence=0.5, lacunarity=2.0):
        ...
        # Optimization: Pre-calculate the grid
        ...
        for i in range(octaves):
            ...
            # Still using loops as opensimplex doesn't support vectorization
            # But let's use a slightly more efficient sampling if we can
    ...
    def generate_roughness_map(self, noise_map, invert=False):
        # Roughness is typically higher in dark/low spots
    ...
    def generate_wood(self):
        # Anisotropic noise for wood grain
        width, height = self.size
        noise_map = np.zeros(self.size)
